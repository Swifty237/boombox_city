    ...
    <div class="col-10 col-lg-7 mt-5">
        ...
        <div class="row card bg-middle pt-2">
            ...
            <div class="card-body">
                ...
                <p class="card-text"><?= $video->resident_id ?></p>
                <p class="card-text"><?= $video->description ?></p>
                <p class="card-text"><?= $video->like_id ?></p>
            </div>

            <button class=" text-white btn city-button col-5 mb-3 d-flex align-self-center justify-content-center">
                <a  class="text-white text-decoration-none" 
                    href= <?= ($video->resident_id == $_SESSION['resident']->id) ? "http://localhost/boombox_city/resident/index.php?page=resident-vmodif&id=".$video->id : "#" ?> >
                    
                        <?= ($video->resident_id == $_SESSION['resident']->id) ? "Modifier" : "Commenter" ?>
                </a>
            </button>
        </div>

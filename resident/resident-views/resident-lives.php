                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="collapse collapse-horizontal" id="poster">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item size"><a class="d-flex justify-content-center text-decoration-none" href="http://localhost/boombox_city/resident/index.php?page=resident-video">Vidéo</a></li>

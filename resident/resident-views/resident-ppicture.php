            ...
            <div class="collapse" id="profil">
                <div class="d-flex flex-column">
                    ...
                    <div class="collapse collapse-horizontal" id="poster">
                        <ul class="list-group">
                            <li class="list-group-item size"><a class="d-flex jsutify-content-center text-decoration-none" href="#">Live</a></li>
                            <li class="list-group-item size"><a class="d-flex jsutify-content-center text-decoration-none" href="http://localhost/boombox_city/resident/index.php?page=resident-pvideo">Vidéo</a></li>
                            <li class="list-group-item size"><a class="d-flex jsutify-content-center text-decoration-none" href="#">Photo</a></li>
                        </ul>
                    </div>

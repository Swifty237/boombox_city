            ...
            <form class="form container-fluid bg-light pt-4" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="mb-3 col-12">
                        <label for="pseudo" class="form-label">Ajoutez un pseudo</label>
                        <input type="text" name="pseudo" id="pseudo" class="form-control">
                    </div>
                    <div class="mb-3 col-12">
                        <label class="my-3 form-label" for ="description">Expliquez ce que vous faites</label>
                        <textarea name="description" id="description" class="form-control h-100 mb-5"></textarea>
                    </div>
                    <div class="mt-5 mb-3 col-12">
                        <label for="image" class="form-label my-3">Choisissez une photo de profil</label>

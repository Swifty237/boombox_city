...
<div class="row block-container justify-content-center">
    ...
    <div class="col-10 col-lg-7 mt-5">
        ...
        <div class="row card bg-middle pt-2">
            <img src="../resources/pictures/<?= $picture->picture_name ?>" alt="" class="card-img-top">
            <div class="card-body">
                <h5 class="card-title"><?= $picture->title  ?></h5>
                <p class="card-text"><?= $picture->resident_id ?></p>
                <p class="card-text"><?= $picture->description ?></p>
                <p class="card-text"><?= $picture->like_id ?></p>
            </div>

            <button class=" text-white btn city-button col-5 mb-3 d-flex align-self-center justify-content-center">
                <a  class="text-white text-decoration-none" 
                    href= <?= ($picture->resident_id == $_SESSION['resident']->id) ? "http://localhost/boombox_city/resident/index.php?page=resident-pmodif&id=".$picture->id : "#" ?> >
                    
                        <?= ($picture->resident_id == $_SESSION['resident']->id) ? "Modifier" : "Commenter" ?>
                </a>
            </button>
        </div>
